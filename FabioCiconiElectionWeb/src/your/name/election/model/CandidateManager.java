...
public class CandidateManager { 
    ...
    // First four methods are not implemented because they not required in this exercise.
    // However they would be implemented in a more generic bean used in other situations.
